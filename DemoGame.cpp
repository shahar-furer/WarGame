...
WarGame::DemoGame::DemoGame() : board(numRows, numCols) {
...
uint WarGame::DemoGame::play() {
    board.move(1, {0, 1},
               Board::MoveDIR::Up);      // FootSoldier of player 1 moves forward and attacks from {0,1} to {1,1}.
